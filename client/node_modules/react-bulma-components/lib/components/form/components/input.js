...
var Input = function Input(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Element, _extends({}, props, {
    ...
    className: classnames('input', className, (_classnames = {
      'is-static': isStatic
    }, _defineProperty(_classnames, "is-".concat(status, "ed"), status), _defineProperty(_classnames, 'is-rounded', rounded), _defineProperty(_classnames, "is-".concat(calculatedSize), calculatedSize), _defineProperty(_classnames, "is-".concat(color), color), _classnames))
  }));
};
